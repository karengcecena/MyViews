...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/user_profile_lists_screenshot.png "MyViews Profile Create Playlists / Watched List & To Be Watch List")

Users have two default playlists to which they can add media to.


![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/edit_watched_list_screenshot.png "MyViews Profile Edit Watched List")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/user_profile_custom_playlists.png "MyViews Profile Playlists")

Users can also create, edit, and delete custom made playlists. 


![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/user_profile_friends_watched_lists_screenshot.png "MyViews Profile Friend Watched Lists")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/friend_profile_screenshot.png "MyViews Friends Profile'")

To add a new friend, a follow button was implemented under the friends username that also uses AJAX


![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/search_page_screenshot.png "MyViews Search Page")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/media_info_screenshot.png "MyViews Media Info")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/add_rating_screenshot.png "MyViews Add Rating")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/media_info_rating_screenshot.png "MyViews Displayed Ratings")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/add_to_lists_screenshot.png "MyViews Add to Lists")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/add_to_playlist_screenshot.png "MyViews Add to Playlists")

This is how users can add new media to their playlists. 


![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/media_recommendations_screenshot.png "MyViews Movie & Show Recommendations")
...
![alt text](https://github.com/karengcecena/project-movie-app/tree/main/static/img/trending_media_screenshot.png "MyViews Trending Movies & Shows")
